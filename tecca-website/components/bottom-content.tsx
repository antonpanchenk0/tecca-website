          ...
          <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-12">
            <div className="lg:w-2/5 flex-shrink-0 text-center lg:text-left">
              ...
              <p className="mt-4 text-muted-foreground text-lg text-balance max-w-md mx-auto lg:mx-0">
                Forget about endless spreadsheets with feedback from your users, tens of chats with
                product managers and developers regarding feature request prioritization, and lost
                notes with feedback that never reaches your team.
              </p>
